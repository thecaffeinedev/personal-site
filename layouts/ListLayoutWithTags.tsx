...
export default function ListLayout({
  ...
  // Group posts by year
  const groupPostsByYear = (postsToGroup: CoreContent<Blog>[]) => {
    const grouped = postsToGroup.reduce((groups: { [key: string]: CoreContent<Blog>[] }, post) => {
    ...
    return Object.entries(grouped)
      ...
      .map(([year, yearPosts]) => ({
        year,
        posts: yearPosts.sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime()),
      }))
  }
